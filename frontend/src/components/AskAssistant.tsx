...
// From seed/questions.txt — both NL→SQL and RAG examples
...
export function AskAssistant({ propertyId }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {EXAMPLE_QUESTIONS.map(q => (
          <button
            ...
            style={{
              ...
              borderRadius: 20, padding: "4px 12px", color: "#94a3b8",
      ...
      {error && (
        <div style={{
          background: "#7f1d1d22", border: "1px solid #ef444455",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {result.type === "rag"     ? "📚 KB Answer"  :
               result.type === "blocked" ? "🚫 Blocked"    :
               result.type === "refused" ? "🤷 Refused"    : "💬 Answer"}
            </div>
